...
import com.ichi2.clickfc.ClickFCApp;
import com.ichi2.clickfc.CollectionHelper;
import com.ichi2.clickfc.R;
import com.ichi2.clickfc.exception.MediaSyncException;
import com.ichi2.clickfc.exception.UnknownHttpResponseException;
...
public class Connection extends BaseAsyncTask<Connection.Payload, Object, Connection.Payload> {
    ...
    public Connection() {
        ...
        Context context = ClickFCApp.getInstance().getApplicationContext();
    ...
    private Payload doInBackgroundLogin(Payload data) {
        ...
        String onlineUrl = "http://clickflashcard.com/webservice/cnwebserv3.php";
        ...
        try {
            ...
            if (!timeoutOccured(e2)) {
                ClickFCApp.sendExceptionReport(e2, "doInBackgroundLogin");
            }
            data.success = false;
    ...
    private Payload doInBackgroundSync(Payload data) {
        ...
        Collection col = CollectionHelper.getInstance().getColSafe(ClickFCApp.getInstance());
        ...
        try {
            ...
            if (conflictResolution == null) {
                ...
                try {
                    ...
                    ClickFCApp.sendExceptionReport(e, "doInBackgroundSync-fullSync");
                    data.success = false;
            ...
            if (media) {
                ...
                try {
                    ...
                    if (ret == null) {
                        mediaError = ClickFCApp.getAppResources().getString(R.string.sync_media_error);
                    } else {
                        ...
                        if (ret.equals("sanityFailed")) {
                            mediaError = ClickFCApp.getAppResources().getString(R.string.sync_media_sanity_failed);
                        } else {
                    ...
                    if (timeoutOccured(e)) {
                        ...
                        ClickFCApp.sendExceptionReport(e, "doInBackgroundSync-mediaSync");
                    }
            ...
            ClickFCApp.sendExceptionReport(e, "doInBackgroundSync");
            return data;
    ...
    public static boolean isOnline() {
        ConnectivityManager cm = (ConnectivityManager) ClickFCApp.getInstance().getApplicationContext()

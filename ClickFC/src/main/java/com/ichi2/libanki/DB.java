...
public class DB {
    ...
    public class MyDbErrorHandler implements DatabaseErrorHandler {
        ...
        public void onCorruption(SQLiteDatabase db) {
            ...
            ClickFCApp.sendExceptionReport(new RuntimeException("Database corrupted"), "DB.MyDbErrorHandler.onCorruption", "Db has been corrupted ");
        ...
        try {
                ...
                try {
                    ...
                    if (cursor.isNull(column)) { // null value encountered
                        ...
                        if (nullExceptionCount == 1) { // Toast and error report first time only
                            nullException = e;
                            Toast.makeText(ClickFCApp.getInstance().getBaseContext(),
            ...
            if (nullExceptionCount > 0) {
                if (nullException != null) {
                    ...
                    ClickFCApp.sendExceptionReport(nullException, "queryColumn_encounteredNull", sb.toString());
                    ...
                    ClickFCApp.sendExceptionReport(new RuntimeException("queryColumn null"), "queryColumn_encounteredNull", sb.toString());

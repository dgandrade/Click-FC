...
import com.ichi2.clickfc.stats.OverviewStatsBuilder;
import com.ichi2.clickfc.stats.StatsMetaInfo;
...
public class Stats {
    ...
    public Object[] getMetaInfo() {
        String title;
        if (mWholeCollection) {
            title = ClickFCApp.getInstance().getResources().getString(R.string.card_browser_all_decks);
        } else {
            try {

...
import com.ichi2.clickfc.ReadText;
    ...
    public long getSoundsLength(int qa) {
        ...
        if (mSoundPaths != null && (qa == Sound.SOUNDS_QUESTION_AND_ANSWER && makeQuestionAnswerList() || mSoundPaths.containsKey(qa))) {
            ...
            for (String uri_string : mSoundPaths.get(qa)) {
                ...
                metaRetriever.setDataSource(ClickFCApp.getInstance().getApplicationContext(), soundUri);
...
//                    Integer.parseInt(soundPath.substring(3, 4)));
            ...
            try {
                ...
                if (mAudioManager == null) {
                    mAudioManager = (AudioManager) ClickFCApp.getInstance().getApplicationContext().getSystemService(Context.AUDIO_SERVICE);
                }
                ...
                mMediaPlayer.setDataSource(ClickFCApp.getInstance().getApplicationContext(), soundUri);

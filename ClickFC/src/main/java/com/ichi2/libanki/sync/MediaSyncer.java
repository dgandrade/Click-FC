            ...
            while (true) {
                ...
                try {
                    ...
                    mCon.publishProgress(String.format(
                            ClickFCApp.getAppResources().getString(R.string.sync_media_changes_count), toSend));
    ...
    private void _downloadFiles(List<String> fnames) {
        ...
        while (fnames.size() > 0) {
            try {
                ...
                mCon.publishProgress(String.format(
                        ClickFCApp.getAppResources().getString(R.string.sync_media_downloaded_count), mDownloadCount));

...
import com.ichi2.clickfc.MetaDB;
import com.ichi2.clickfc.services.NotificationService;
...
public final class WidgetStatus {
    ...
    public static void update(Context context) {
        SharedPreferences preferences = ClickFCApp.getSharedPrefs(context);

...
import com.ichi2.clickfc.exception.StorageAccessException;
...
public class Preferences extends AppCompatPreferenceActivity implements PreferenceContext, OnSharedPreferenceChangeListener {
        ...
        switch (action) {
            ...
            case "com.ichi2.clickfc.prefs.reviewing":
                ...
                fullscreenPreference.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
                    public boolean onPreferenceChange(Preference preference, final Object newValue) {
                        SharedPreferences prefs = ClickFCApp.getSharedPrefs(Preferences.this);
            ...
            case "com.ichi2.clickfc.prefs.custom_buttons":
                ...
                reset_custom_buttons.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    public boolean onPreferenceClick(Preference preference) {
                        SharedPreferences.Editor edit = ClickFCApp.getSharedPrefs(getBaseContext()).edit();
                ...
                break;
            case "com.ichi2.clickfc.prefs.advanced":
                ...
                customSyncServerPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    public boolean onPreferenceClick(Preference preference) {
                        Intent i = CompatHelper.getCompat().getPreferenceSubscreenIntent(Preferences.this,
                                "com.ichi2.clickfc.prefs.custom_sync_server");
                        startActivity(i);
                        return true;
                    }
                });
                ...
                advancedStatisticsPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    public boolean onPreferenceClick(Preference preference) {
                        Intent i = CompatHelper.getCompat().getPreferenceSubscreenIntent(Preferences.this,
                                "com.ichi2.clickfc.prefs.advanced_statistics");
                        startActivity(i);
                        return true;
                    }
                });
                ...
                break;
            case "com.ichi2.clickfc.prefs.custom_sync_server":
                ...
                break;
            case "com.ichi2.clickfc.prefs.advanced_statistics":
        ...
        try {
            ...
            switch (key) {
                ...
                case "reportErrorMode": {
                    ...
                    ClickFCApp.getInstance().setAcraReportingMode(value);
                    ClickFCApp.getSharedPrefs(this).edit().remove("sentExceptionReports").apply();    // clear cache
                    break;
                }
                case "syncAccount": {
                ...
                case "providerEnabled": {
                    ComponentName providerName = new ComponentName(this, "com.ichi2.clickfc.provider.CardContentProvider");
                    PackageManager pm = getPackageManager();
                    int state;
                    if (((CheckBoxPreference) pref).isChecked()) {
                         state = PackageManager.COMPONENT_ENABLED_STATE_ENABLED;
                        Timber.i("ClickFC ContentProvider enabled by user");
                    } else {
                        state = PackageManager.COMPONENT_ENABLED_STATE_DISABLED;
                        Timber.i("ClickFC ContentProvider disabled by user");
                    }
    ...
    private void updateSummary(Preference pref) {
        ...
        if (pref.getKey().equals("about_dialog_preference")) {
            ...
            if (!ClickFCApp.getSharedPrefs(this).getBoolean("useCustomSyncServer", false)) {
                pref.setSummary(R.string.disabled);
            } else {
                pref.setSummary(ClickFCApp.getSharedPrefs(this).getString("syncBaseUrl", ""));
            }
        }
          else if (pref.getKey().equals("advanced_statistics_link")) {
            if (!ClickFCApp.getSharedPrefs(this).getBoolean("advanced_statistics_enabled", false)) {
                pref.setSummary(R.string.disabled);
            } else {

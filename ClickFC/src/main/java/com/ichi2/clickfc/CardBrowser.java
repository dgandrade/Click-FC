...
import com.ichi2.clickfc.dialogs.CardBrowserContextMenu;
import com.ichi2.clickfc.dialogs.CardBrowserMySearchesDialog;
import com.ichi2.clickfc.dialogs.CardBrowserOrderDialog;
...
import com.ichi2.clickfc.widgets.DeckDropDownAdapter;
...
public class CardBrowser extends NavigationDrawerActivity implements
            ...
            if (which != mOrder) {
                ...
                try {
                    if (mOrder == 0) {
                        ...
                        ClickFCApp.getSharedPrefs(getBaseContext()).edit()
    ...
    protected void onCollectionLoaded(Collection col) {
        ...
        mColumn1Index = ClickFCApp.getSharedPrefs(getBaseContext()).getInt("cardBrowserColumn1", 0);
        cardsColumn1Spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                ...
                if (pos != mColumn1Index) {
                    mColumn1Index = pos;
                    ClickFCApp.getSharedPrefs(ClickFCApp.getInstance().getBaseContext()).edit()
        ...
        mColumn2Index = ClickFCApp.getSharedPrefs(getBaseContext()).getInt("cardBrowserColumn2", 0);
    ...
    private void showTagsDialog() {
        TagsDialog dialog = com.ichi2.clickfc.dialogs.TagsDialog.newInstance(

...
public class AnkiDroidCrashReportDialog extends BaseCrashReportDialog implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (which == DialogInterface.BUTTON_POSITIVE) {
            ...
            if (autoReport) {
                preferences.edit().putString("reportErrorMode", ClickFCApp.FEEDBACK_REPORT_ALWAYS).commit();
                ClickFCApp.getInstance().setAcraReportingMode(ClickFCApp.FEEDBACK_REPORT_ALWAYS);
            }

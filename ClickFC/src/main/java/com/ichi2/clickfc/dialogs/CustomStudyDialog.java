 ...
 ****************************************************************************************/
package com.ichi2.clickfc.dialogs;
...
import com.ichi2.clickfc.DeckOptions;
import com.ichi2.clickfc.R;
import com.ichi2.clickfc.Reviewer;
...
public class CustomStudyDialog extends DialogFragment {
                    ...
                    public void onPositive(MaterialDialog dialog) {
                        ...
                        switch (dialogId) {
                            case CUSTOM_STUDY_NEW:
                                try {
                                    ClickFCApp.getSharedPrefs(getActivity()).edit().putInt("extendNew", n).commit();
                            ...
                            case CUSTOM_STUDY_REV:
                                try {
                                    ClickFCApp.getSharedPrefs(getActivity()).edit().putInt("extendRev", n).commit();
                                    JSONObject deck = col.getDecks().get(did);
    ...
    private String getDefaultValue() {
        SharedPreferences prefs = ClickFCApp.getSharedPrefs(getActivity());
        switch (getArguments().getInt("id")) {
            case CUSTOM_STUDY_NEW:

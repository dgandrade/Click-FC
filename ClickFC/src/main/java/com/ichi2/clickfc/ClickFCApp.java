...
import com.ichi2.clickfc.dialogs.AnkiDroidCrashReportDialog;
...
@ReportsCrashes(
        ...
        formUri = "http://clickflashcard.com/webservice/ankierror/getform.php",
        ...
        additionalSharedPreferences = {"com.ichi2.clickfc"},
        ...
        logcatArguments = { "-t", "100", "-v", "time", "ActivityManager:I", "SQLiteLog:W", ClickFCApp.TAG + ":D", "*:S" }
)
public class ClickFCApp extends Application {

    public static final String XML_CUSTOM_NAMESPACE = "http://arbitrary.app.namespace/com.ichi2.clickfc";
    ...
    public static final String TAG = "ClickFC";
    // Singleton instance of this class.
    private static ClickFCApp sInstance;
    ...
    public void onCreate() {
        ...
        if (CollectionHelper.hasStorageAccessPermission(this)) {
            try {
                ...
                Timber.e(e, "Could not initialize ClickFC directory");
                ...
                if (isSdCardMounted() && CollectionHelper.getCurrentAnkiDroidDirectory(this).equals(defaultDir)) {
                    ...
                    sendExceptionReport(e, "ClickFCApp.onCreate");
                }
            }
        }
    }
    ...
    public static ClickFCApp getInstance() {
        return sInstance;
    }

...
package com.ichi2.clickfc.multimediacard.fields;
...
import com.ichi2.clickfc.multimediacard.activity.LoadPronounciationActivity;
import com.ichi2.clickfc.multimediacard.activity.PickStringDialogFragment;
import com.ichi2.clickfc.multimediacard.activity.TranslationActivity;
...
public class BasicTextFieldController extends FieldControllerBase implements IFieldController,
    ...
    /*
     * (non-Javadoc)
     * @see com.ichi2.clickfc.IFieldController#onActivityResult(int, int, android.content.Intent) When activity started

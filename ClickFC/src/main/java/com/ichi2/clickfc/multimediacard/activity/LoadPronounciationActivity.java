...
import com.ichi2.clickfc.multimediacard.beolingus.parsing.BeolingusParser;
import com.ichi2.clickfc.multimediacard.language.LanguageListerBeolingus;
...
public class LoadPronounciationActivity extends Activity implements OnCancelListener {
    ...
    // Must be passed in
    public static String EXTRA_SOURCE = "com.ichi2.clickfc.LoadPronounciationActivity.extra.source";
    // Passed out as a result
    public static String EXTRA_PRONUNCIATION_FILE_PATH = "com.ichi2.clickfc.LoadPronounciationActivity.extra.pronun.file.path";

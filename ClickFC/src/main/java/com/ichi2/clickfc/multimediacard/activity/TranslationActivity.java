...
import com.ichi2.clickfc.multimediacard.glosbe.json.Meaning;
import com.ichi2.clickfc.multimediacard.glosbe.json.Phrase;
import com.ichi2.clickfc.multimediacard.glosbe.json.Response;
import com.ichi2.clickfc.multimediacard.glosbe.json.Tuc;
import com.ichi2.clickfc.multimediacard.language.LanguagesListerGlosbe;
import com.ichi2.clickfc.runtimetools.TaskOperations;
import com.ichi2.clickfc.web.HttpFetcher;
...
public class TranslationActivity extends FragmentActivity implements DialogInterface.OnClickListener, OnCancelListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SharedPreferences preferences = ClickFCApp.getSharedPrefs(getBaseContext());

...
public class CollectionHelper {
    ...
    public synchronized Collection getColSafe(Context context) {
        try {
            ...
            ClickFCApp.sendExceptionReport(e, "CollectionHelper.getColSafe");
            return null;
        }
    }
    ...
    public static synchronized void initializeAnkiDroidDirectory(String path) throws StorageAccessException {
        ...
        if (!dir.exists() && !dir.mkdirs()) {
            throw new StorageAccessException("Failed to create ClickFC directory");
        }
        if (!dir.canWrite()) {
            throw new StorageAccessException("No write access to ClickFC directory");
        }
    ...
    public static String getDefaultAnkiDroidDirectory() {
        return new File(Environment.getExternalStorageDirectory(), "ClickFC").getAbsolutePath();
    }

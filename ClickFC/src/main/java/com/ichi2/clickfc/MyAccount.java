...
public class MyAccount extends AnkiActivity {
    ...
    private void saveUserInformation(String username, String hkey, List<Produto> result) {
        SharedPreferences preferences = ClickFCApp.getSharedPrefs(getBaseContext());
        ...
        editor.putString("products",sproducts);
    ...
    Connection.TaskListener loginListener = new Connection.TaskListener() {
        ...
        public void onPostExecute(Payload data) {
            ...
            if (data.success) {
                ...
                saveUserInformation((String) data.data[0], (String) data.data[1],(List<Produto>)data.result);

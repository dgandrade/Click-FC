...
public class NavigationDrawerActivity extends AnkiActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void initNavigationDrawer(View mainView){
        ...
        final SharedPreferences preferences = ClickFCApp.getSharedPrefs(NavigationDrawerActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        SharedPreferences preferences = ClickFCApp.getSharedPrefs(this);
        // Update language
        ClickFCApp.setLanguage(preferences.getString(Preferences.LANGUAGE, ""));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nav_settings:
                ...
                break;
            case R.id.nav_help:
                openUrl(Uri.parse(ClickFCApp.getManualUrl()));
                break;
            case R.id.nav_feedback:
                openUrl(Uri.parse(ClickFCApp.getFeedbackUrl()));
                break;
            default:
                return false;
        }

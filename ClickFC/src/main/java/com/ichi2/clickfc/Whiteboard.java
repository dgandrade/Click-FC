...
public class Whiteboard extends View {
    ...
    public Whiteboard(AnkiActivity context, boolean inverted, boolean monochrome) {
        ...
        int wbStrokeWidth = ClickFCApp.getSharedPrefs(context).getInt("whiteBoardStrokeWidth", 6);
    ...
    private static int getDisplayHeight() {
        Display display = ((WindowManager) ClickFCApp.getInstance().getApplicationContext().

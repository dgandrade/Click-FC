...
import com.ichi2.clickfc.DeckPicker;
import com.ichi2.clickfc.Preferences;
...
public class CompatV10 implements Compat {
    ...
    */
    ...
    public void setFullScreen(AbstractFlashcardViewer a) {
        ...
        final int fullscreenMode = Integer.parseInt(ClickFCApp.getSharedPrefs(a).getString("fullscreenMode", "0"));
